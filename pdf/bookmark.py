...
class MyPDFHandler(object):
    ...
    def __init__(self, pdf_file_path, mode=PDFHandleMode.NEWLY):
        '''
        用一个PDF文件初始化
    ...
    def add_one_bookmark(self, title, page, parent=None, color=None, fit='/Fit'):
        ...
        self.__bookmarks[title] = bookmark
    ...
    def add_bookmarks(self, bookmarks):
        ...
        :return: None
        '''
        for parent_title, title, page in bookmarks:
            self.add_one_bookmark(title=title, page=page, parent=self.__bookmarks.get(parent_title, None))
            ...
            for line in fin:
                ...
                if title and page:
                    try:
                        ...
                        bookmarks.append((parent_title, title, page))
